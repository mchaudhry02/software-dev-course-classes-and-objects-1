...
public class StringUtilities {
    ...
    // Add a static function called shortString that takes a String parameter and
    // returns true if the string has fewer than 5
    // characters
    ...
    // Add a static function called censorAsparagus that takes a String parameter
    // and returns the string with all instances of
    ...
    // returns the longer of the two strings. If the
